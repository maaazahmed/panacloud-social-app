...
import { requestList, groupListAction, myGroupsAction } from "../../../store/action/action"
...
class RequestList extends Component {
    ...
    componentWillMount() {
        ...
        this.props.myGroupsAction(JoinedGroupsArr)
    }
    ...
    render() {
        let request_list = this.props.request_list.requestList;
        let myGroups = this.props.myGroups.myGroups
                ...
                <View style={styles.GroupListContainer} >
                    <FlatList
                        ...
                        renderItem={({ item, index }) => {
                            let a = myGroups.filter((b) => {
                                if (b.groupID === item.groupData.key) {
                                    return b
                                }
                            })
                            if (a.length) {
